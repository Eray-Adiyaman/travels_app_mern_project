  ...
  return (
      <Paper sx={styles.paper}>
        <form style={styles.form} autoComplete="off" noValidate onSubmit={handleSubmit}>
          ...
          <TextField name="message" variant="outlined" margin="dense" label="Message" fullWidth value={postData.message} onChange={(e)=> setPostData({...postData,tags: e.target.value})}></TextField>
